				...
				<div className="relative h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col mb-10 overflow-hidden">
					...
					<div className="z-10 w-full absolute md:w-auto md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 pt-4 backdrop-filter backdrop-blur-sm md:backdrop-blur-none md:backdrop-filter-none bg-gray-100 bg-opacity-50 md:bg-transparent md:pt-0">
						...
						<p className="title  text-xl mt-4 tracking-wider text-gray-900 leading-[1.7rem] mb-5">
							Ini adalah salah satu project yang telah {" "}
				...
				<div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
					...
					<motion.div
						...
						<p className="text-gray-600 text-justify title text-lg">
							Proyek ini merupakan pengalaman kerja saya yang penuh dengan proses pembelajaran hal-hal baru. Istilah "Barkitchen" merujuk pada dua bagian utama, yaitu bar dan kitchen.
                            Saya pertama kali bekerja di bagian Bar, yang mencakup proses penjualan produk serta pembuatan berbagai makanan ringan dan minuman sederhana. Sementara itu, di bagian Kitchen, 
							saya terlibat dalam proses memasak makanan, meracik bumbu, serta memastikan seluruh bahan siap untuk diolah dan disajikan.
						</p>{" "}
						<div className="mt-3">
